...
![Wazuh Security Events — Rule 92653 and 92652](../screenshots/wazuh-rule-92653-92652.jpg)
*Wazuh Security events page showing Rule ID 92653 (jaime RDP logon from 10.1.16.2) and Rule ID 92652 (NTLM authentication / possible pass-the-hash) on DC10, 31 March 2023.*
...
![auditpol output — all categories No Auditing](../screenshots/auditpol-no-auditing.jpg)
*`auditpol /get /category:*` on DC10 — every category showing No Auditing confirms auditing was completely disabled by the attacker.*
