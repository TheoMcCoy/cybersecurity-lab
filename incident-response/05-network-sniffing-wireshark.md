...
![Wireshark capture — DNS traffic on eth0](../screenshots/wireshark-dns-capture.jpg)
*Wireshark three-pane view: DNS query/response packets captured on eth0. The middle pane shows protocol headers (Ethernet, IPv4, UDP, DNS) and the bottom pane shows the raw hex and ASCII representation of the selected frame.*
